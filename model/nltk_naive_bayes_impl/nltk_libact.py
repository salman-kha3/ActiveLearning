...
from classifiers.nb_nltk import NaiveBayes
from query_strategies.QueryStrategyImpl import UncertaintySampling
...
train_set, test_set = featuresets[:1000], featuresets[1700:]
...
model = NaiveBayes(label_probdist, feature_probdist)
